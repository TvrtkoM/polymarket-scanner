  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Allow browser notifications to receive alerts even when your focus is on another tab.
        Alerts always appear as toasts within the app regardless of this setting.
      </p>
      {permission === 'granted' ? (
