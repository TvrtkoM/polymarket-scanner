 ...
 */
export function checkPriceMove24h(market: Market, threshold = 0.1): boolean {
  return Math.abs(market.oneDayPriceChange) >= threshold
}
 ...
 *
 * @param market - The market to evaluate.
 * @param outcomeLabel - Label of the outcome to inspect.
